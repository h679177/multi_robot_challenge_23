...
class LeaderClass(Node):
    def __init__(self):
        ...
        #-----------------------------------------------------------------------------------
        # Create a subscriber to each of the robot_handler publishers
        ...
        self.sub_tb3_0_test = self.create_subscription(Float64, 'tb3_1/namespace_test', self.clbk_tb3_1_test, 10)
