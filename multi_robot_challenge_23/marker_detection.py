...
class MarkerDetection(Node):
    def __init__(self):
        ...
        self.marker_pose_sub = self.create_subscription(Int64, 'tb3_0/marker_id', self.clbk_marker_id, 10)
        self.marker_id_sub = self.create_subscription(Pose, 'tb3_0/marker_map_pose', self.clbk_marker_map_pose, 10)
